...
commitments, proofs, transcripts, ProofLists, receipts, schemas, conformance
vectors, or wire encodings relative to `v0.0.7-rc.5`. The release WASM assets
are rebuilt from the renamed module and bind the new repository, module,
commit, and checksums in their provenance.
