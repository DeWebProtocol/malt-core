...
- the experimental client-root profiles documented in
  [Client-Root Contract](https://github.com/dewebprotocol/malt-core/blob/a4526f8751db403eaa2e1a7ac6add00b70ff2933/docs/spec/client-root-contract.md);
...
in [historical WASM Release Assets](https://github.com/DeWebProtocol/malt-core/blob/v0.0.7/docs/policy/wasm-release-assets.md).
